...
class <?php echo $theme_namespace;?>_theme_admin_controller
{
	private $lib;
	public function __construct($data)
	{
        ...
        $this->lib	=	new <?php echo $theme_namespace;?>_theme_library($data);
	...
	{
    	// DEFINE THEME TITLE //
		set_page('title','2TB &raquo; <?php echo addslashes($theme_human_name);?> - Gestion du thème');
        // END THEME TITLE //
	...
	{
    	// DEFINE THEME TITLE //
		set_page('title','2TB &raquo; A propos de  <?php echo addslashes($theme_human_name);?>');
        // END THEME TITLE //
        // DEFINE THEME DESCRIPTION //
        set_page('description','Thème cr&eacute;e avec 2TB');
        // END THEME DESCRIPTION //
