<section> {blog_single_isset_start}
    ...
    <div id="comments">
        ...
        <ul>
          ...
          <li> <span><a href="#">{blog_single_comments_loop_author_pseudo}</a> {blog_single_comments_loop_timestamp}</span><p>{blog_single_comments_loop_content}</p></li>
            {blog_single_comments_loop_end}
        </ul>
      	{blog_single_comments_isset_else}
      <h5>Aucune commentaire disponible</h5>
        {blog_single_comments_isset_end} 
