<?php 
class gumbo_theme_admin_controller
{
	private $lib;
	public function __construct($data)
	{
        ...
        $this->lib	=	new gumbo_theme_library($data);
	...
	{
    	// DEFINE THEME TITLE //
		set_page('title','2TB &raquo; gumbo - Gestion du thème');
        // END THEME TITLE //
	...
	{
    	// DEFINE THEME TITLE //
		set_page('title','2TB &raquo; A propos de  gumbo');
        // END THEME TITLE //
        // DEFINE THEME DESCRIPTION //
        set_page('description','Thème cr&eacute;e avec 2TB');
        // END THEME DESCRIPTION //
