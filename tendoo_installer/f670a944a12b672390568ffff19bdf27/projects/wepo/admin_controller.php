<?php 
class wepo_theme_admin_controller
{
	private $lib;
	public function __construct($data)
	{
        ...
        $this->lib	=	new wepo_theme_library($data);
	...
	{
    	// DEFINE THEME TITLE //
		set_page('title','2TB &raquo; wepo - Gestion du thème');
        // END THEME TITLE //
	...
	{
    	// DEFINE THEME TITLE //
		set_page('title','2TB &raquo; A propos de  wepo');
        // END THEME TITLE //
        // DEFINE THEME DESCRIPTION //
        set_page('description','Thème cr&eacute;e avec 2TB');
        // END THEME DESCRIPTION //
